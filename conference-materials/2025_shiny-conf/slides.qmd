...
- Our framework flows through 5 stages: Notice → Interpret → Structure → Anticipate → Validate
  * Click through
- Notice identifies friction points where users struggle with the interface
- Interpret uncovers what story users truly need - moving from symptoms to diagnosis
- Structure organizes information in ways that align with how our brains process information
- Anticipate considers cognitive biases affecting data interpretation
- Validate ensures users leave with clear takeaways and a positive impression
- Remember, these stages are iterative - you'll often revisit earlier stages as you discover new insights
:::
...
- BID integrates established best practices from multiple disciplines - we're truly standing on the shoulders of giants
...
- Unlike typical checklists, BID guides how you think about dashboards from psychological first principles
...
- **Stage 1 (Notice):** Users were overwhelmed with options
  * This relates to 'cognitive load' - the mental effort needed to process information
  * When the brain gets overtaxed, comprehension drops
  * Hick's Law shows decision time increases logarithmically with more choices
- **Stage 2 (Interpret):** We identified what users needed - increased Processing Fluency
  * When information is easy to process, people find it more credible
  * We focused on the key story executives needed, not showing all possible data
- **Stage 3 (Structure):** We applied the 'Principle of Proximity' in the structure stage...which is about grouping related elements together
  * We also make use of Dual-Processing Theory (which distinguishes between fast, intuitive thinking and slower, deliberative thinking) in the design to create logical groupings of metrics for more intuitive workflows
- Now let's see how we brought these concepts to life
:::
...
- For the later BID stages, we addressed subtler psychological factors affecting interpretation and action
...
- This illustrates the powerful psychological principles at work...we're showing identical data but creating completely different mental states
- Progress framing highlights achievement and builds confidence...marketing team preferred this approach
- Gap framing creates urgency and focuses on improvements needed - product teams used this view
- "This isn't just theory - a classic study showed that people react completely differently when presenting identical medical treatment outcomes as either a 90% survival rate or a 10% mortality rate ... even though it's the same data"
- Consider how framing in your dashboards might drive different decisions
:::
...
- The `{bidux}` package directly implements our 5-stage framework
...
- Currently, `{bidux}` has helper functions for all 5 stages of the BID framework [CLICK]
- **Notice tab**
