...
- The client loved it bc..."users could analyze anything they want!"
...
- This chart is behavioral science screaming "STOP DOING THIS TO YOUR USERS!"
...
- And decades of research shows people are often irrational...but in consistent ways
- For us as developers...this means our strange user behaviors are predictable...and we can design for them
...
- 14 filters hardly ever used...and 4 virtually ignored
- This is technical debt visualized
- Each unused filter is maintenance overhead...and there are probably database queries running for nothing bc of those unused filters
...
- Here...90% confidence Cognitive Load Theory is relevant...too many choices paralyzing users
- But it could suggest Choice Overload...Analysis Paralysis...or Decision Fatigue...depending on your context
...
- [CLICK] Look at theses suggestions...anchoring, framing, confirmation bias
- These are the bugs in human cognition that affect every user...but now we can guard for them
...
- So critical KPIs or summaries are placed at the top...supporting details follow the F-pattern...deep-dive options progressively disclosed
...
- For example...executive summaries tailored to personas...
    - Maybe we use more technical wording for analysts...but high-level for execs
- This stage also generates checklists...checks accessibility...and creates those "aha" moments
...
- On average, session duration increased on by 2.6 minutes...which is the difference between "I have to use this" and "I want to use this"
- Faster load times...
- Multiply that by hundreds of users, daily visits...that's hours of collective time saved
- Daily active users increased by 85...
- Query success rate went up from 76% to 87%...
- And the reason this works is because human psychology is predictable
...
- Engineering for psychology = better dashboard engineering = happier developers and users
- [end by 14:10]
:::
...
- ...And you can run this during the early stages of development too!
- It's a shift-left for user experience...fixing problems before they're problems
- [end by 15:40]
:::
...
- [CLICK] There's also a bid_concepts function to explore specific behavioral principles you may not be familiar with...it's like having a psychology textbook on hand for further reading
...
- [CLICK] Before I close...I want to offer my heartfelt thanks to the posit::conf organizers for creating this incredible space...to the Shiny community for pushing the boundaries of what's possible...and most importantly, to all of you...for taking the time to be here today and for caring about your users
