...
### Quick show of hands:
- Built Shiny app 10+ filters?
- User asked "one more dropdown"?
- More `selectInput()` than insights?
:::
...
::: {.column width="20%"}
![](img/bid-framework.png){width="100%"}
:::
::::
...
::: {.column width="30%"}
![](img/hex-bidux.png){class="hex-logo" width="200"}
:::
::::
