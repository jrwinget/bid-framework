...
- Now I'd like you to imagine you're NOT a data scientist...
- You're an executive who needs to make a decision in the next 10 mins
...
- [CLICK] If you're nodding along...you're among friends...No judgment here
- [CLICK] I'm Jeremy...and I've been there too
- I'm a psychologist by training...but probably not the kind you're thinking of
...
- They don't fail bc of the wrong chart type or database
- They fail because humans need to use them...and humans are complicated
- But we can engineer for psychology just as precisely as we engineer for performance
...
::: {.text-box-overlay-dark .absolute left="-200" bottom="100"}
...
::: {.notes}
- [45 seconds]
- This is a dashboard from an actual client...details blinded of course, but still accurate
...
- The client loved this bc..."users can analyze anything they want!"
- Except...they never did
- The opened the app...but didn't stay long before they completely deserted it
...
::: {.notes}
- [35 seconds]
- And in this case...it painted a user journey like this cliff of despair
...
- But here's where it gets brutal...only 52% applied even one filter. Just one!
- And only 20% returned within 7 days
- This chart is behavioral science screaming "STOP DOING THIS!"
- But what needs fixing...and how do we do it?
- [end by 3:20]
:::
...
::: {.notes}
- [75 seconds]
- With behavioral science!...which is the study of how humans think, feel and act...often in the context of decision making
- The field itself is a blend of psychology, economics, neuroscience, and others...
- But across all those areas we find people are often irrational...but in consistent ways
- For us as developers...this is actually great news!
- It means user behavior is predictable...and we can design for it
- [CLICK] Let me share a study that demonstrates our death by dropdown problem perfectly
- [CLICK] In this study...two researchers set up a sampling booth at a grocery store...and they varied the number of jams they on display
- [CLICK] In the big display condition...there was were 24 jams on the table...and in the small display condition...there were 6 jams
...
- So more choice attracted attention but paralyzed action...and filter-heavy dashboards do the exact same thing
- [end by 4:30]
:::
...
- But these aren't abstract theories...they're actually engineering principles we can leverage
...
- Progressive Disclosure...this means revealing complexity gradually as users need it
    - Show vital information first...and reveal more as needed
...
- Choice Architecture...this means guiding the user without restricting them
    - Hide rarely used filters, use smart defaults
    - Like good API design...guide users down the happy path
...
- But what if you don't know behavioral science?
- [end by 5:35]
:::
...
- That's where the Behavioral Insight Design (BID) framework comes in...[CLICK]
    - It's like having GPS for your behavioral science journey
- Five simple stages that guide you through the process...and help prevent those dashboard disasters we've all seen
- What makes BID different is it's not some abstract design theory
- It's a concrete...step-by-step framework built on decades of research
- Each stage feeds into the next...creating this continuous feedback loop that keeps improving your dashboard
- Plus...the whole thing is already bundled into an R package that handles the heavy lifting
- [end by 6:20]
:::
...
- Got telemetry? Great, it'll analyze actual user behavior and give you data-driven insights
...
- If you can't state it in one simple sentence...they won't find it in a bunch of dropdowns
- [CLICK] And the data story helps create narrative structure for this
- Humans are hardwired for stories...not pivot tables
- Hook, context, tension, resolution...is the same structure folks are looking for with their key insights...so we build that in from the start
- [CLICK] And finally...the user personas help us devs take the user perspective
- The Product Manager isn't you...they don't think in SQL queries...They think in business outcomes
- So the dashboard needs to bridge that gap
- [CLICK] And when we put it all of that information together...the function creates a summary for you to review before moving on
- If it tells you anything is missing...it could also be a good time to check in with your users
- [end by 8:10]
:::
...
::: {.notes}
- [75 seconds]
- Bc when we don't consider that context...we end up building critical friction points into our dashboards
- Going back to that opening example...here's what filter usage looked like
- 14 filters basically unused...4 virtually ignored
- This is technical debt visualized
- Each unused filter is maintenance overhead...and there are probably database queries running for nothing
...
- But it might suggest Choice Overload...Analysis Paralysis...or Decision Fatigue
...
- The package also links each theory to specific Shiny components that address it
...
- Same data...but different psychological impact
...
::: {.notes}
- [65 seconds]
- At this point...we know what the dashboard is for, what problems to fix, and what biases to guard against
...
- [CLICK] See this F-pattern heatmap? This is how users scan dashboards in Western cultures
...
- Critical KPIs or Summaries go on the top...supporting details follow the F-pattern...deep-dive options progressively disclosed
- This is cognitive engineering...you're structuring information to match how the human brain processes visual data
...
- This helps you know the dashboard works as intended...and helps users know what to do next
- It guides you through testing changes and iterating...but also suggests ways to empower user engagement
- For example...executive summaries tailored to personas...detailed wording for analysts, high-level for execs
- This stage generates checklists...checks accessibility...and creates those "aha" moments
- It's the difference between "I looked at the dashboard" and "I know exactly what to do now"
...
::: {.notes}
- [25 seconds]
- Here's our dashboard disaster again...18 filters, 6 tabs, information overload incarnate
...
- That's the difference between a proper tool and shelfware
- This isn't magic...or AI...it's engineering for how humans actually think
...
- And that's the difference between building features and products people love
- [end by 13:25]
:::
...
- They all suffer from choice overload...
...
- [CLICK] If you have telemetry...simply load it with bid_telemetry
- [CLICK] Here...I'm filtering to to one of the critical issues identified
- [CLICK] Then adding a simple question the dashboard is trying to answer to contextualize everything that follows
- [CLICK] And then I use bid_notice_issues...a bridge function from telemetry to behavioral insights that auto-populates the following stages
- [CLICK] From there...it's running through the remaining stages...
- [CLICK] And ending with bid_report to optionally generate a markdown report ready for your PR or documentation
- [end by 14:50]
:::
...
- [CLICK] Create your data story...to structure the dashboard's narrative
- [CLICK] Identify the friction points...even without data...you probably know where users struggle
